...
public class GoRestWithLombokSchema {

    static Logger logger = LogManager.getLogger(GoRestWithLombokSchema.class);
...
//                .when().post("https://gorest.co.in/public/v2/users")
                ...
                .contentType(ContentType.JSON)
                //validating the schema response body
                // with rest assured schema validation library
                .assertThat()
